...
class History(keras.callbacks.Callback):
    ...
    def on_batch_end(self, batch, logs={}):
        ...
        with open('256gru40.pickle', 'wb') as handle:
            pickle.dump(self.losses, handle)
    #save five models to use later to show text gen
    def on_epoch_end(self, epoch, logs={}):
        if epoch % 20 == 0:
            self.model.save("256gru40_at_epoch{}.hd5".format(epoch))
...
model = load_model('256gru40_at_epoch0.hd5')
...
# plt.show()
plt.savefig('lossplot_256gru40.png')
